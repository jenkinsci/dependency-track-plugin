...
**Project Properties**: Allows to update some project properties after uploading the BOM, such as tags, SWID and vendor. The API key provided requires the `PORTFOLIO_MANAGEMENT` permission to use this feature!
