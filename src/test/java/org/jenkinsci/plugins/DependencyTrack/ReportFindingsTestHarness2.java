...
public class ReportFindingsTestHarness2 {
	static String apikey="-apikey-";
    
    static public List<ReportFindings2> getReportFindings() {
    	return ReportFindingsFactory2.getReportFindings(new ArrayList<Finding>(Arrays.asList(
